# Contributing to TriAgentFlow

*Formerly HTE / Hermes Team Engine.*

Thank you for your interest in contributing to TriAgentFlow! We welcome contributions from the community.
...
# Run controlled parallelism tests
bash scripts/e2e-parallel-workflow-test.sh

# Run release protocol lint
...
# Run lifecycle tests (legacy, non-blocking for v1.5 release)
...
**Architectural changes must follow [docs/PROJECT_BOUNDARIES.md](docs/PROJECT_BOUNDARIES.md).**

**New files/scripts/dependencies must respect [docs/COMPLEXITY_BUDGET.md](docs/COMPLEXITY_BUDGET.md).**

**Validation requirements should follow [docs/VALIDATION_MAP.md](docs/VALIDATION_MAP.md).**
...
Thank you for contributing to TriAgentFlow / TAF! 🚀
