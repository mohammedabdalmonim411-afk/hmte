...
The legacy HTE / Hermes Team Engine project was originally developed for **Claude Code** and has been migrated to **Hermes**. This document explains the architectural differences between the two platforms and why certain directory structures are preserved.
...
|---------------------------|-------------------|
| `.claude/skills/legacy-team-engine/` | `~/.hermes/profiles/default/skills/hmte/` |
