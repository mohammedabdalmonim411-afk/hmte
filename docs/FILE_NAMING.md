...
> **Note**: TAF runtime artifact naming (evidence, verdict, receipt, command log) 以 [docs/HTE_PROTOCOL.md §8 File Naming Conventions](HTE_PROTOCOL.md#8-file-naming-conventions) 为准。本文主要描述仓库普通文件命名约定。

This document describes the file naming conventions used in the TriAgentFlow / TAF project.
