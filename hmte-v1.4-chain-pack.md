...
详见 `.hmte/team-rules.md` 中的"最终声明规则"。
===== END FILE: src/skills/hmte/SKILL.md =====
...
# --- 3. Project-plane files: per-file ownership chain ---
# For each project-plane file X, find the SPECIFIC evidence E that claims X,
# then verify E's full chain: worker receipt → command log → verdict → phase_gate.
# This prevents "泛认领" (old evidence claiming a file that was later re-modified).
if project_files:
    # Build evidence index: {file_path: [evidence_info, ...]}
    evidence_index = {}  # {file_path: [(evidence_path, phase_id, attempt), ...]}
    ...
    for pf in project_files:
        ...
        for ev_rel, pid, att in evidence_index.get(pf, []):
            ...
            # 3b. Command log existence and runner check
            ...
            # 3d. Phase gate pass-through (verdict already verified above)
            # Full phase_gate execution requires the script to be present;
            # the verdict check above already validates the core requirements.
            pass
...
./.phase_control_archive/20260529_155208/instructions/final_audit_attempt_1_verifier.json
./.phase_control_archive/20260529_155208/instructions/final_audit_attempt_1_worker.json
./.phase_control_archive/20260529_155208/instructions/p0_critical_attempt_1_verifier.json
./.phase_control_archive/20260529_155208/instructions/p0_critical_attempt_1_worker.json
./.phase_control_archive/20260529_155208/instructions/phase_1_kickoff_attempt_1_verifier.json
```
