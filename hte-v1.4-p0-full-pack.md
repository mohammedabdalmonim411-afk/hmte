...
is_implementation_phase() {
    local pid="$1"
    # Phase IDs starting with phase_, p, or impl are implementation phases
    if [[ "$pid" == phase_* ]] || [[ "$pid" == p[0-9]* ]] || [[ "$pid" == impl* ]]; then
        return 0
    fi
    return 1
}
