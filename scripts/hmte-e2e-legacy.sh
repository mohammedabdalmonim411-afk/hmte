#!/bin/bash
# End-to-End test for TAF legacy hmte runtime
...
phases:
  - id: phase_test
    name: "Test Phase"
    objective: "Verify TAF legacy hmte runtime works"
    inputs:
      - "Test input"
    outputs:
      - "Test output"
...
echo ""
echo "TAF is ready to use! (legacy hmte command prefix)"
