#!/usr/bin/env bash
# hmte-init.sh - 初始化 TAF 项目（legacy hmte CLI）
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "🚀 Initializing TAF legacy hmte runtime in: $TARGET"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
# 检查是否已有 TAF legacy hmte 规则
if ! grep -q "# TAF Legacy hmte Runtime Files" .gitignore 2>/dev/null; then
    cat >> .gitignore <<'EOF'

# TAF Legacy hmte Runtime Files
...
EOF
    ...
    warn ".gitignore already has TAF legacy hmte rules, skipping"
fi
...
# TAF Legacy hmte Phase Control Directory

This directory contains TAF legacy hmte runtime state and artifacts.
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "✅ TAF legacy hmte runtime initialized successfully!"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "Next steps:"
